...
public class GUI extends Application {
	...
	public void start(Stage stage) {
		...
		try {
			...
			gp.addColumn(0, setTitleL, setAuthorL, setPublisherL, setYearL,
					setGenreL, setPlotL, setPagesL,setCoverL,addBookBtn);
			...
			gp.addColumn(1, setTitleTF, setAuthorTF, setPublisherTF, setYearTF, 
					setGenreTF,setPlotTF, setPagesTF,setCoverTF,mainMenu2);
	...
	public BorderPane listAllBooks(Button mainMenu7) {
        ...
        tableData.addAll(new Book("Harry","JK","Wizards","Fantasy","Bloom","No cover",1999,400));
